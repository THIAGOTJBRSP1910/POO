...
public class GerenciarUsuarios extends JFrame{
	...
	public static void main(String[] args) {
		...
		janela.setTitle("Gerenciar Usuarios");
		janela.setLocationRelativeTo(null);//alinha a janela ao centro da tela
		//retira a janela da memoria quando clica no botão fechar
		...
		/*
		 * O fato de voce ter configurado o gerenciador de layout
		 ...
		 * a chamada do método cadastrar que esta na classe Usuario
		 */
